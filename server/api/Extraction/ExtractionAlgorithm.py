...
file_path = "C:\\Users\\khale\\OneDrive\\Documents\\TekUp\\TekUp Project\\DATA"

champsLexical = ['PROGRAMATION C', 'C', 'JAVA',
                 'DJANGO', 'NODE', 'NODE.JS',
                 'ANGULAR', 'REACT', 'IONIC',
                 'BLOCKCHAIN', 'MACHINE LEARNING',
                 'ML', 'QUALITE LOGICIELLE', 'Qualité logicielle',
                 'WEB MARKETING', 'AWS', "Droit de l'entreprise", "Développement logiciel"
                 'DevOps', 'DevOps 2', 'Intelligence artificielle']
...
# read your file
file = r'C:/Users/khale/OneDrive/Documents/TekUp/TekUp Project/tekup-project/server/api/Extraction/DATA/test4.pdf'
if file.endswith('.pdf'):
    ...
    for i in range(len(pdf_file)):
        for img in pdf_file.getPageImageList(i):
            ...
            img_name = os.path.join(file_path, "p"+str(i)+"-"+str(xref)+".png")
...
for listD in data:
    for word in listD:
        if(word.upper() in champsLexical or word in champsLexical):
            found.append(word)


score = len(set(found)) * 10
status = "en cours"

if score >= 70:
    status = "accepté non confirmé"
